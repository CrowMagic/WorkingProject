...
//
//  Created by giikylee on 16/7/18.
...
#define kWZLBadgeDefaultFont				([UIFont boldSystemFontOfSize:11])

#define kWZLBadgeDefaultMaximumBadgeNumber                     70
...
- (void)showNumberBadgeWithValue:(NSInteger)value
{
    ...
    self.badge.layer.borderColor = [UIColor greenColor].CGColor;
    self.badgeBgColor = [UIColor whiteColor];
    self.badge.tag = WBadgeStyleNumber;
    self.badge.font = self.badgeFont;
    self.badge.text = [NSString stringWithFormat:@"%ld",value];
...
- (void)badgeInit
{
    ...
    if (self.badgeTextColor == nil) {
        self.badgeTextColor = [UIColor greenColor];
    }
