...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [bt_add setBackgroundColor:[UIColor colorWithRed:236/255.0 green:236/255.0 blue:236/255.0 alpha:1]];
        [bt_add addTarget:self action:@selector(addCount) forControlEvents:UIControlEventTouchUpInside];
        ...
        tf_count.backgroundColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1];
        ...
        [bt_reduce setBackgroundColor:[UIColor colorWithRed:236/255.0 green:236/255.0 blue:236/255.0 alpha:1]];
...
-(void)addCount
{
    NSInteger count = 0;
    count++;
    tf_count.text = [NSString stringWithFormat:@"%ld",count];
    NSLog(@"+++++++++++++++++++++++++++++++++++++");
}
/*
