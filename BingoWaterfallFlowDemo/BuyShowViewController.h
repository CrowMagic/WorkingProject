...
@interface BuyShowViewController : UIViewController
...
@property(nonatomic,strong)UIButton *addToCarBtn;//加入购物车
@property(nonatomic,strong)UIButton *determineBtn;//立即购买
//
@end
